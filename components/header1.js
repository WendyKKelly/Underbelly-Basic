      ...
      <div className="container mx-auto flex flex-col flex-wrap items-center">
        ...
        <div>
          ...
          <div className="flex mb-2">
            ...
            <div>
              <Link href="/bpage/[slug]" as="/bpage/about">
                <a className="text-white px-8 truncate">About</a>
              </Link>
            </div>

            <div>
              <Link href="/bpage/[slug]" as="/bpage/contact">
                <a className="text-white px-8 truncate">Contact</a>
              </Link>
            </div>
          </div>
        </div>
